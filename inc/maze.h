...
Vector horizontal_lines(Maze *maze, float ra, float Tan, int *vmt);
Vector vertical_lines(Maze *maze, float ra, float Tan, int *hmt);
Vector cast_ray(Maze *maze, Vector *arr,  int dof, float dis, int *mapt);
